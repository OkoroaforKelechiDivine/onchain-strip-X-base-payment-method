  ...
  Widget buildTransactionCard() {
    return Padding(
      padding: EdgeInsets.only(
        left: widget.isSent ? 200 : 0,
        right: widget.isSent ? 0 : 200,
        top: 50,
      ),
      child: GestureDetector(
        onTap: () {
          navigationService.push(
            TransactionDetailsScreen(amount: widget.amount, transactionTimestamp: widget.transactionTimestamp, accountName: widget.accountName, bankName: "Bank Name",)
          );
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Text(
                ""
                    "${widget.transactionTimestamp.hour.toString().padLeft(2, '0')}:"
                    "${widget.transactionTimestamp.minute.toString().padLeft(2, '0')} "
                    "${widget.transactionTimestamp.hour >= 12 ? 'PM' : 'AM'}",
                style: TextStyle(
