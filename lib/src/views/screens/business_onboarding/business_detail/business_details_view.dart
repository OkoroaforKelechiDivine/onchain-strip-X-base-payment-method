...
class BusinessDetailsView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ViewModelBuilder.reactive(
      ...
      onModelReady: (model) {
        model.getTransactionCount(business.id.toString());
      },
        ...
        return Scaffold(
          ...
          body: Stack(
            children: [
                          ...
                          InkWell(
                            onTap: () {
                              if (!business.accredited) {
                                model.getConsent(
                                    bvn: business.contactPerson.bvn,
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              SizedBox(height: 10),
                              AppText(
                                model.transactionCountResponse == null
                                    ? "---"
                                    : "₦${model.transactionCountResponse!.totalTransactionAmount}",
                                fontSize: 20,
                                fontWeight: FontWeight.w700,
                                color: AppColors.white,
                              ),
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              AppText(
                                model.transactionCountResponse == null
                                    ? "----"
                                    : "${model.transactionCountResponse!.totalTransactionCount}",
                                fontSize: 20,
                                fontWeight: FontWeight.w700,
                                color: AppColors.white,
                              ),
              ...
              Visibility(
                visible: model.isLoadingBusinessCount || model.isLoadingConsent,
